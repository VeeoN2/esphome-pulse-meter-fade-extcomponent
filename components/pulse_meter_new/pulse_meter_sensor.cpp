  ...
  if (this->get_->count_ > 0) {
    ...
    switch (this->meter_state_) {
      ...
      case MeterState::RUNNING: {
        ...
        this->last_time_since_valid_edge_us_  = pulse_width_us;
  ...
  // No detected edges this loop
    ...
    switch (this->meter_state_) {
      ...
      case MeterState::RUNNING: {
        if (time_since_valid_edge_us > this->timeout_us_) {
        ...
        } else if (this->fade_mode_ && (time_since_valid_edge_us >= this->last_time_since_valid_edge_us_ * 2)) {
          ...
          this->last_time_since_valid_edge_us_ = time_since_valid_edge_us;
